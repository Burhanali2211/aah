    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-orange-50">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Fast, secure delivery of pure attars, concentrated perfumes, Islamic literature & hijabs
          </motion.p>
          <motion.p
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            We ship our pure attars, concentrated perfume oils, authentic Islamic books, and hijabs across India and select international locations.
