        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-8">
            <Link to="/" className="flex items-center group">
              <img src="/logo.png" alt="AligarhAttarHouse Logo" className="h-14 w-auto object-contain group-hover:scale-105 transition-transform duration-500" />
            </Link>

              <p className="text-gray-500 leading-relaxed max-w-sm font-medium text-sm">
                Premium authentic attars, concentrated perfume oils, fine Islamic literature, luxury hijabs, abayas & Islamic lifestyle essentials — crafted with purity and elegance.
              </p>
