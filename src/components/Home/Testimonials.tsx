  ...
  const fetchTestimonials = async () => {
    try {
      ...
      if (reviewsData && reviewsData.length > 0) {
        const allTestimonials: Testimonial[] = reviewsData.map((review: any) => ({
          quote: review.comment || review.title || 'Great product!',
          ...
          product: review.products?.name || 'Exclusive Product',
        ...
        setStats({
          totalCustomers: allTestimonials.length * 10, // Simulated scale for marketing
